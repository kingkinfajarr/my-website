      ...
      <div className="flex md:min-h-screen flex-col items-center justify-center md:px-40 px-4">
        ...
        <main className="flex w-full flex-1 flex-col items-center justify-center text-center">
          <div className="md:w-full md:h-96 h-64 bg-slate-300 rounded-lg bg-cover bg-center overflow-hidden md:mt-20">
            <Image src={'https:' + thumbnail.fields.file.url} width={thumbnail.fields.file.details.image.width} height={thumbnail.fields.file.details.image.height} className="bg-cover bg-center" />
          </div>
