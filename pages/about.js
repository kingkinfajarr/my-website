        ...
        <main className='flex w-full flex-1 flex-col'>
          ...
          <div className='mt-10'>
            <p className='mb-4 text-left leading-7'>
              Hi, I&apos;m{" "}
              <span className='font-semibold'>Kingkin Fajar Anifianto</span>,
              people who know me usually call me{" "}
              <span className='font-semibold'>Kingkin</span> ({getAge()}),
              Developer who also likes to make UI Design, passionate about
              programming after graduating from junior high school, I continue
              to study at a vocational high school majoring in software
              engineering.
            </p>
            <p className='md:block text-left leading-7'>
              I focus on Frontend Development, for now, I spend a lot of time to
              explore about Frontend Development using React JS, Next JS and
              also explore about mobile development using Flutter.
            </p>
          </div>
          <div className='md:p-5 p-2 bg-green-200/70 rounded-lg mt-10'>
            <h1 className='md:pb-5 md:mb-0 mb-5 md:mt-0 mt-2 md:text-2xl text-xl font-semibold md:text-left text-center'>
          ...
          <div className='md:p-5 p-2 bg-green-200/70 rounded-lg mt-6 md:mb-0 mb-10'>
            <h1 className='pb-5 md:mt-0 mt-2 md:text-2xl text-xl font-semibold md:text-left text-center'>
            ...
            <div className='grid md:grid-cols-3 grid-cols-1 gap-2 md:gap-3'>
              ...
              <div className='bg-green-100 h-16 rounded-lg items-center flex hover:bg-transparent transition-all duration-200 hover:translate-x-1'>
                <div className='flex items-center mx-auto'>
                  <img
                    src='./images/tools/bitbucket.svg'
                    alt='Bitbucket Logo'
                    className='w-7 mr-3'
                  />
          ...
          <p className='md:mt-8 mb-3 md:text-2xl text-xl font-semibold md:text-left text-center'>
            You can reach me here
          </p>
          <div className='grid md:grid-cols-3 grid-cols-1 gap-2 md:gap-3'>
            <a
              href='mailto:kingkinnfajar@gmail.com'
              target='_blank'
              rel='noopener noreferrer'
              className='w-full h-14 bg-red-600 rounded-lg flex items-center hover:translate-x-1 transition-all duration-300'
            >
            ...
            <a
              href='https://t.me/kingkinfajarr'
              target='_blank'
              rel='noopener noreferrer'
              className='w-full h-14 bg-blue-500 rounded-lg flex items-center hover:translate-x-1 transition-all duration-300'
            >
              <p className='flex items-center text-white mx-auto font-semibold'>
            ...
            <a
              ...
              target='_blank'
              rel='noopener noreferrer'
              className='w-full h-14 bg-black rounded-lg flex items-center hover:translate-x-1 transition-all duration-300'
            >
              <p className='flex items-center text-white mx-auto font-semibold'>
            ...
            <a
              href='https://www.linkedin.com/in/kingkinfajarr/'
              target='_blank'
              rel='noopener noreferrer'
              className='w-full h-14 bg-sky-500 rounded-lg flex items-center hover:translate-x-1 transition-all duration-300'
            >
              <p className='flex items-center text-white mx-auto font-semibold'>
            ...
            <a
              ...
              target='_blank'
              rel='noopener noreferrer'
              className='w-full h-14 bg-pink-600 rounded-lg flex items-center hover:translate-x-1 transition-all duration-300'
            >
              <p className='flex items-center text-white mx-auto font-semibold'>
            ...
            <a
              href='https://twitter.com/kingkinfajarr'
              target='_blank'
              rel='noopener noreferrer'
              className='w-full h-14 bg-sky-400 rounded-lg flex items-center hover:translate-x-1 transition-all duration-300 md:mb-0 mb-14'
            >
              <p className='flex items-center text-white mx-auto font-semibold'>
